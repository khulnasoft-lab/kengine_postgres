...
export POSTGRES_MULTIPLE_DATABASES="$KENGINE_POSTGRES_USER_DB_NAME"
export POSTGRES_USER=$KENGINE_POSTGRES_USER_DB_USER
if [ -z "$POSTGRES_USER" ]; then
    export POSTGRES_USER="khulnasoft"
fi
export POSTGRES_PASSWORD=$KENGINE_POSTGRES_USER_DB_PASSWORD
